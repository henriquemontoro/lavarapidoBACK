...
# 3.1. Fonte de conhecimento do assistente: mantém aqui em vez de ler de um
...
- **Polimento**: Serviço de correção da pintura executado no Container de Polimento, com uso de politriz. Preço de 500 reais, igual para qualquer porte de veículo. Consome o dia de trabalho do colaborador que o executa e é sempre executado depois da lavagem e antes da Cera.
...
- **Higienização de Bancos**: Serviço de higienização dos bancos do veículo, cobrado pelo veículo inteiro e não por banco. Preço de 75 reais para bancos de couro e de 50 reais para bancos de tecido, igual para qualquer porte de veículo. É sempre o último serviço executado, e exige secagem antes da entrega.
...
- **Tempo Prometido de Entrega**: Horário de conclusão informado ao cliente no momento da abertura da Ordem de Serviço, definido pelo Atendente em função dos serviços contratados, da quantidade de veículos em fila e das condições climáticas. Não há tabela de tempos-padrão; sua elaboração depende de medição em operação real, ainda não realizada.
...
Definir o Tempo Prometido de Entrega considerando os serviços contratados, a quantidade de veículos em fila e as condições climáticas, e registrá-lo na Ordem de Serviço. SE houver Higienização de Bancos contratada ENTÃO acrescentar o tempo de secagem, que varia conforme as condições climáticas do dia. Não há tabela de tempos-padrão; sua elaboração depende de medição em operação real, ainda não realizada.
...
SE houver Polimento contratado ENTÃO executá-lo com politriz sobre o veículo já lavado e seco, e registrar no Dashboard a conclusão. O Polimento consome o dia de trabalho do colaborador que o executa.
...
Cronometrar os tempos de execução dos Colaboradores por serviço e por etapa, e registrar os tempos aferidos no Dashboard. A cronometragem é a fonte da tabela de tempos-padrão, hoje inexistente, da qual depende o cálculo objetivo do Tempo Prometido de Entrega previsto na etapa 16.
