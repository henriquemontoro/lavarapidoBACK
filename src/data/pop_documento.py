...
# 3.3. Fonte de conhecimento do assistente: mantém aqui em vez de ler de um
...
- **Escala de Trabalho**: Distribuição fixa da equipe pelos dias de operação. A unidade conta com 9 Colaboradores, dos quais 6 em regime de cinco dias de trabalho por dois de folga e 3 em regime de quatro dias de trabalho por três de folga. A presença por dia é fixa: 6 Colaboradores na segunda-feira, na terça-feira e na quarta-feira, e 8 Colaboradores na quinta-feira, na sexta-feira e no sábado, reforçando os dias de maior movimento. O Atendente cumpre regime de cinco dias por dois e folga às terças-feiras. O Gerente, o Atendente e o Responsável Administrativo não integram a contagem dos 9 Colaboradores.
...
- Tarefa "Conferir a presença da equipe contra a Escala de Trabalho e alocar os Colaboradores no início do dia": o papel **Gerente** tem responsabilidade *Responsável e Aprovador*.
- Tarefa "Acumular a função de Atendente às terças-feiras": o papel **Gerente** tem responsabilidade *Responsável e Aprovador*.
- Tarefa "Exercer as funções de Gerente nos dias de folga do titular": o papel **Proprietário** tem responsabilidade *Responsável e Aprovador*.

## Procedimento
### Etapa 1 — Responsável: Gerente
No início de cada dia de operação, conferir a presença da equipe contra a Escala de Trabalho e definir a alocação dos Colaboradores aos Boxes de Lavagem, ao Container de Polimento e às demais posições. SE o número de Colaboradores presentes for inferior ao previsto na Escala de Trabalho para aquele dia ENTÃO reduzir o número de Boxes de Lavagem simultâneos e revisar o Tempo Prometido de Entrega dos veículos em fila.

### Etapa 2 — Responsável: Gerente
Às terças-feiras, acumular a função de Atendente durante todo o horário de funcionamento, executando as etapas atribuídas a esse papel, em razão da folga do titular prevista na Escala de Trabalho.

### Etapa 3 — Responsável: Proprietário
SE o Gerente estiver de folga ENTÃO exercer as funções de Gerente durante todo o horário de funcionamento, incluindo a conferência de qualidade por amostragem e a redistribuição de tarefas. É proibido operar sem que as funções de Gerente e de Atendente estejam cobertas.

### Etapa 4 — Responsável: Atendente
Manter a Vaga de Recepção livre e sinalizada durante todo o horário de funcionamento, das 08:00 às 17:00, de segunda a sábado. SE a Vaga de Recepção estiver ocupada por veículo já pronto ENTÃO acionar o Colaborador para transferi-lo à Vaga de Entrega ou às Vagas do Fundo antes de receber novo veículo.
...
### Etapa 26 — Responsável: Atendente
...
### Etapa 27 — Responsável: Atendente
...
### Etapa 28 — Responsável: Atendente
...
### Etapa 55 — Responsável: Colaborador
...
### Etapa 56 — Responsável: Colaborador
...
### Etapa 57 — Responsável: Colaborador
...
### Etapa 62 — Responsável: Atendente
...
### Etapa 63 — Responsável: Atendente
...
### Etapa 65 — Responsável: Responsável Administrativo
...
### Etapa 66 — Responsável: Responsável Administrativo
...
### Etapa 67 — Responsável: Atendente
...
### Etapa 68 — Responsável: Atendente
...
### Etapa 69 — Responsável: Atendente
...
### Etapa 70 — Responsável: Responsável Administrativo
...
### Etapa 71 — Responsável: Responsável Administrativo
...
### Etapa 75 — Responsável: Proprietário
...
- SE um Colaborador faltar em relação à Escala de Trabalho do dia ENTÃO o Gerente redistribui as tarefas do dia entre os Colaboradores presentes, reduz o número de Boxes de Lavagem simultâneos conforme a equipe disponível, revisa o Tempo Prometido de Entrega dos veículos em fila e comunica os clientes afetados, e registra a ocorrência no Registro de Anomalias. Não há suplência previamente designada entre os Colaboradores; a designação das tarefas do dia é atribuição do Gerente.
...
- SE o Gerente e o Proprietário estiverem ambos ausentes em um dia de operação ENTÃO o Atendente assume a coordenação do dia limitada à recepção, ao sequenciamento da fila e à entrega, ficando suspensas a conferência de qualidade por amostragem e a cronometragem previstas para o Gerente. Registrar a ocorrência no Registro de Anomalias. É proibido conceder isenção, desconto ou reparo por conta da unidade na ausência do Proprietário.

## Histórico de Revisões
- Versão 1.0: Versão inicial, elaborada a partir da transcrição da sessão de imersão com o Proprietário.
- Versão 2.0: Alterou o horário de funcionamento, incorporou os Planos de Assinatura, fixou papéis por colaborador.
- Versão 3.0: Institui o Dashboard como sistema único de registro, Catálogo de Serviços completo, Ordem de Execução dos Serviços, Planos de Assinatura com dois contadores.
- Versão 3.1: Cria o papel de Gerente e o papel único de Colaborador, renomeia Recepcionista de Pátio para Atendente.
- Versão 3.2: Institui a Tabela de Tempos-Padrão no corpo do procedimento.
- Versão 3.3 (vigente): Encerra a operação aos domingos. Institui a Escala de Trabalho: 9 Colaboradores (6 em 5x2, 3 em 4x3), presença fixa de 6 colaboradores de segunda a quarta e 8 de quinta a sábado. Define cobertura de folgas: Atendente folga terça (Gerente acumula), Gerente folga (Proprietário acumula).
"""
